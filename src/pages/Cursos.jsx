...
export default function Cursos() {
    return (
        <div className="flex flex-1 flex-row w-full max-w-[1440px] mx-auto">
            {/* Sidebar */}
            <aside className="hidden lg:flex w-64 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 gap-6 shrink-0">
                <div>
            ...
            <main className="flex-1 overflow-y-auto px-6 py-8 lg:px-10">
                ...
                <section className="mb-12">
                    ...
                    <div className="group relative flex flex-col xl:flex-row items-stretch rounded-xl overflow-hidden shadow-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="flex w-full xl:w-1/3 flex-col justify-center p-8 lg:p-10 gap-4">
                            ...
                            <h3 className="text-slate-900 dark:text-white text-2xl lg:text-3xl font-bold leading-tight">Configurando o Novo Fluxo de Notas Fiscais</h3>
                ...
                <section className="mb-12">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link to="/trilha" className="text-primary text-sm font-semibold hover:underline">Ver tudo</Link>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {/* Video Card 1 */}
                        <div className="group flex flex-col gap-3">
                            <Link to="/aula" className="relative aspect-video rounded-lg overflow-hidden bg-slate-200 dark:bg-slate-800 cursor-pointer block">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Relatórios Gerenciais Dinâmicos</Link>
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Exportação de Dados para Excel</Link>
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Conciliação Bancária Automatizada</Link>
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Busca Avançada de Pedidos</Link>
                ...
                <section className="mb-12">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-2">
                            <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-400 hover:text-primary">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Introdução ao Sistema para Novos Usuários</Link>
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Cadastro de Clientes e Fornecedores</Link>
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Emissão de Nota Fiscal Eletrônica (NF-e)</Link>
                        ...
                        <div className="group flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link to="/aula" className="text-slate-900 dark:text-white font-semibold line-clamp-2 hover:text-primary transition-colors">Gerenciamento de Fluxo de Caixa</Link>
                ...
                <section className="mb-8">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link to="/manuais" className="text-primary text-sm font-semibold hover:underline">Baixar tudo</Link>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <Link to="/manuais" className="flex items-center p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 hover:border-primary transition-colors cursor-pointer group">
                            <div className="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-600 flex items-center justify-center mr-4 shrink-0">
                                <span className="material-symbols-outlined text-2xl">picture_as_pdf</span>
                            </div>
                            <div className="flex-1 overflow-hidden">
                                <h5 className="text-sm font-bold text-slate-900 dark:text-white truncate">Manual_Fiscal_v2.4.pdf</h5>
                                <p className="text-xs text-slate-500">2.4 MB • Atualizado em Jan 2024</p>
                            </div>
                            <span className="material-symbols-outlined text-slate-300 group-hover:text-primary transition-colors ml-2">download</span>
                        </Link>
                        <Link to="/manuais" className="flex items-center p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 hover:border-primary transition-colors cursor-pointer group">
                            <div className="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-600 flex items-center justify-center mr-4 shrink-0">
                                <span className="material-symbols-outlined text-2xl">picture_as_pdf</span>
                            ...
                            <div className="flex-1 overflow-hidden">
                                <h5 className="text-sm font-bold text-slate-900 dark:text-white truncate">Guia_Rapido_Atalhos.pdf</h5>
                        ...
                        <Link to="/manuais" className="flex items-center p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 hover:border-primary transition-colors cursor-pointer group">
                            ...
                            <div className="flex-1 overflow-hidden">
                                <h5 className="text-sm font-bold text-slate-900 dark:text-white truncate">Fluxograma_Vendas_v3.pdf</h5>
